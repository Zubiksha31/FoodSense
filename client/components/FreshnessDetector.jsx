...
const FreshnessDetector = () => {
  ...
  useEffect(() => {
    localStorage.setItem('foodDetectionHistory', JSON.stringify(history));
  }, [history]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-100 font-sans overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 py-8 w-full flex flex-col">
        ...
        <motion.div
          ...
          className="bg-white/20 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden flex flex-col lg:flex-row flex-grow"
        >
          {/* Side Navigation */}
                ...
                >
                  ...
                  <div className="grid lg:grid-cols-2 gap-6 flex-grow">
                      ...
                      >
                        {!imagePreview ? (
                          <div className="h-full flex flex-col items-center justify-center text-center border-2 border-dashed border-indigo-200 rounded-xl p-8 hover:border-indigo-400 transition-all duration-300">
                            ...
                            <p className="text-gray-500 mb-6">Take a clear photo of your food item to check its freshness</p>
                            <label className="block">
                              ...
                              <motion.span
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="inline-block bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white py-4 px-8 rounded-xl cursor-pointer transition-all duration-300 shadow-md font-medium"
                              >
                                Take Photo
                              </motion.span>
                            </label>
                          ...
                          <div className="h-full flex flex-col">
                            <div className="relative rounded-xl overflow-hidden shadow-lg flex-grow">
                              <img src={imagePreview} alt="Food preview" className="w-full h-full object-cover" />
                              <motion.button
                                whileHover={{ scale: 1.1 }}
                                whileTap={{ scale: 0.95 }}
                                onClick={handleRetake}
                                className="absolute top-4 right-4 bg-white/90 p-3 rounded-full shadow-md hover:bg-white transition-all duration-300"
                    ...
                    <div className="flex flex-col">
                      ...
                      {(!imagePreview || (imagePreview && !loading && result)) && (
                        <motion.div
                        ...
                        >
                          ...
                          <ul className="space-y-4">
                            {[
                              'Take photos in good lighting for the most accurate results',
                              'Position the camera close enough to capture details of the food’s surface',
                              'For best results, scan fruits and vegetables with visible surfaces',
                            ].map((tip, index) => (
                              <motion.li
                                key={index}
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    {['Apples', 'Bananas', 'Oranges', 'Potatoes', 'Capsicum', 'Bitter Gourds'].map(item => (
                      <div key={item} className="bg-white/30 backdrop-blur-md py-3 px-4 rounded-lg text-sm text-center shadow-sm font-medium text-gray-700">{item}</div>
                    ))}
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-gray-600">
                    FreshSense leverages advanced computer vision technology powered by a deep learning model trained on thousands of food images. 
                    The AI analyzes visual cues such as color, texture, and surface patterns to estimate freshness levels. 
                    Each scan provides a confidence score, reflecting the model’s certainty in its assessment. 
                    The system is designed for ease of use, but results are based solely on visual data and should be supplemented with other safety checks.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <div className="bg-red-50/70 backdrop-blur-md border border-red-100 rounded-xl p-5 mb-4">
                    <p className="text-gray-700 mb-3">
                      FreshSense is a tool designed to assist users in assessing food freshness, but it has limitations. Please read the following carefully:
                    </p>
                    <ul className="space-y-2 text-gray-600">
                      {[
                        ...
                        'Accuracy may vary depending on lighting conditions, camera quality, and the clarity of the image provided.',
                ...
                >
                  ...
                  <div className="bg-indigo-50/70 backdrop-blur-md rounded-xl p-5">
                    <ul className="space-y-3 text-gray-600">
                      {[
                        'Ensure good lighting when taking photos for the most accurate assessment',
                        'Focus clearly on the food item without obstructions in the image',
                        'Use the confidence score as a guide, but always perform sensory checks (smell, touch) before consuming food',
                        'If you suspect spoilage, err on the side of caution and discard the item',
                      ].map((item, index) => (
